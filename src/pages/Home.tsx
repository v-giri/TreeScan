...
export function Home() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="px-4 md:px-8 max-w-screen-xl mx-auto pt-14 pb-4">
      ...
      {/* Hero Card */}
      <motion.div
        className="mx-4 md:px-8 max-w-screen-xl md:mx-auto bg-sage-deep rounded-[28px] p-5 overflow-hidden relative"
      ...
      {/* Quick Actions */}
      <div className="px-4 mt-4 grid grid-cols-3 gap-2.5 md:max-w-xl md:mx-auto">
        {[
      ...
      {/* Recent Scans */}
      <div className="px-4 md:px-8 max-w-screen-xl mx-auto mt-6">
